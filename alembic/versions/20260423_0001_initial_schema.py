...
def upgrade() -> None:
	...
	op.create_table(
		...
		sa.Column(
			"account_type", postgresql.ENUM(AccountType, name="shared_account_type", create_type=False), nullable=False
		),
	...
	op.create_table(
		...
		sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=False),
		sa.ForeignKeyConstraint(
			["account_id"], ["accounts.id"], name=op.f("fk_auditor_profiles_account_id_accounts"), ondelete="CASCADE"
		),
		sa.ForeignKeyConstraint(
	...
	op.create_index(
		op.f("ix_auditor_profiles_auditor_profiles_account_id"), "auditor_profiles", ["account_id"], unique=False
	)
	op.create_index(
		op.f("ix_auditor_profiles_auditor_profiles_auditor_code"), "auditor_profiles", ["auditor_code"], unique=True
	)
	...
	op.create_table(
		...
		sa.ForeignKeyConstraint(
			["account_id"], ["accounts.id"], name=op.f("fk_manager_invites_account_id_accounts"), ondelete="CASCADE"
		),
		sa.ForeignKeyConstraint(
			["invited_by_user_id"],
			["users.id"],
	...
	op.create_table(
		...
		sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=False),
		sa.ForeignKeyConstraint(
			["account_id"], ["accounts.id"], name=op.f("fk_manager_profiles_account_id_accounts"), ondelete="CASCADE"
		),
		sa.ForeignKeyConstraint(
	...
	op.create_table(
		...
		sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=False),
		sa.ForeignKeyConstraint(
			["account_id"], ["accounts.id"], name=op.f("fk_projects_account_id_accounts"), ondelete="CASCADE"
		),
		sa.ForeignKeyConstraint(
			["created_by_user_id"], ["users.id"], name=op.f("fk_projects_created_by_user_id_users"), ondelete="RESTRICT"
		),
	...
	op.create_table(
		...
		sa.Column("accepted_at", sa.DateTime(timezone=True), nullable=True),
		sa.ForeignKeyConstraint(
			["account_id"], ["accounts.id"], name=op.f("fk_auditor_invites_account_id_accounts"), ondelete="CASCADE"
		),
		sa.ForeignKeyConstraint(
			["auditor_id"],
			["auditor_profiles.id"],
	...
	op.create_table(
		...
		sa.ForeignKeyConstraint(
			["project_id"], ["projects.id"], name=op.f("fk_project_places_project_id_projects"), ondelete="CASCADE"
		),
	...
	op.create_table(
		...
		sa.ForeignKeyConstraint(
			["place_id"], ["places.id"], name=op.f("fk_yee_audit_submissions_place_id_places"), ondelete="CASCADE"
		),
	...
	op.create_table(
		...
		sa.ForeignKeyConstraint(
			["project_id"], ["projects.id"], name=op.f("fk_auditor_assignments_project_id_projects"), ondelete="CASCADE"
		),
		sa.PrimaryKeyConstraint("id", name=op.f("pk_auditor_assignments")),
		sa.UniqueConstraint(
			"auditor_profile_id", "project_id", "place_id", name="uq_auditor_assignments_auditor_project_place"
		),
	)
	op.create_index(
	...
	op.create_index(
		op.f("ix_auditor_assignments_auditor_assignments_place_id"), "auditor_assignments", ["place_id"], unique=False
	)
	op.create_index(
	...
	op.create_table(
		...
		sa.Column(
			"status", postgresql.ENUM(AuditStatus, name="shared_audit_status", create_type=False), nullable=False
		),
		...
		sa.ForeignKeyConstraint(
			["project_id"], ["projects.id"], name=op.f("fk_audits_project_id_projects"), ondelete="CASCADE"
		),
	...
	op.create_index(
		op.f("ix_playspace_audit_sections_playspace_audit_sections_audit_id"),
		"playspace_audit_sections",
		["audit_id"],
		unique=False,
	)
	op.create_table(
		...
		sa.UniqueConstraint(
			"audit_id", "field_key", "selected_value", name="uq_playspace_pre_audit_answers_audit_field_value"
		),
	)
	op.create_index(
		op.f("ix_playspace_pre_audit_answers_playspace_pre_audit_answers_audit_id"),
		"playspace_pre_audit_answers",
		["audit_id"],
		unique=False,
	)
	op.create_table(
		...
		sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=False),
		sa.ForeignKeyConstraint(
			["section_id"], ["playspace_audit_sections.id"], name="fk_ps_question_response_section", ondelete="CASCADE"
		),
...
def downgrade() -> None:
	...
	op.drop_index(
		op.f("ix_playspace_audit_sections_playspace_audit_sections_audit_id"), table_name="playspace_audit_sections"
	)
	...
	op.drop_index(
		op.f("ix_auditor_assignments_auditor_assignments_auditor_profile_id"), table_name="auditor_assignments"
	)
